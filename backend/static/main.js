...
var author$project$Main$ChoreConf = function (a) {
	return {$: 'ChoreConf', a: a};
};
var author$project$Main$Chore = F2(
	function (start, threshold) {
		return {start: start, threshold: threshold};
	});
...
var author$project$Main$choreDecoder = A3(
	elm$json$Json$Decode$map2,
	author$project$Main$Chore,
	A2(elm$json$Json$Decode$field, 'start_time', elm$json$Json$Decode$int),
...
var author$project$Main$choresDecoder = elm$json$Json$Decode$dict(author$project$Main$choreDecoder);
...
var author$project$Main$getChoreConf = elm$http$Http$get(
	{
		expect: A2(elm$http$Http$expectJson, author$project$Main$ChoreConf, author$project$Main$choresDecoder),
		url: 'http://127.0.0.1:8000/chores/list'
	});
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(author$project$Main$Loading, author$project$Main$getChoreConf);
};
...
var author$project$Main$Schedule = F2(
	function (chores, timer) {
		return {chores: chores, timer: timer};
	});
var author$project$Main$Success = function (a) {
	return {$: 'Success', a: a};
};
var author$project$Main$ChoreReset = function (a) {
	return {$: 'ChoreReset', a: a};
};
...
var author$project$Main$updateChore = function (chore_name) {
	return elm$http$Http$post(
		{
			body: elm$http$Http$emptyBody,
			expect: elm$http$Http$expectWhatever(author$project$Main$ChoreReset),
			url: 'http://127.0.0.1:8000/chores/' + chore_name
		});
};
var author$project$Main$updateTimer = F2(
	function (posix, schedule) {
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Tick':
				...
				switch (model.$) {
					...
					case 'Error':
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					default:
						var schedule = model.a;
						return _Utils_Tuple2(
							author$project$Main$Success(
								A2(author$project$Main$updateTimer, posix, schedule)),
							elm$core$Platform$Cmd$none);
				}
			case 'Reset':
				var chore_name = msg.a;
				return _Utils_Tuple2(
					model,
					author$project$Main$updateChore(chore_name));
			case 'ChoreConf':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var chores = result.a;
			...
			default:
				return _Utils_Tuple2(model, author$project$Main$getChoreConf);
		}
	});
var aforemny$material_components_web_elm$Material$Button$buttonConfig = {additionalAttributes: _List_Nil, dense: false, disabled: false, icon: elm$core$Maybe$Nothing, onClick: elm$core$Maybe$Nothing, trailingIcon: false};
...
var aforemny$material_components_web_elm$Material$Button$clickHandler = function (_n0) {
...
var aforemny$material_components_web_elm$Material$Button$denseCs = function (_n0) {
	var dense = _n0.dense;
...
var aforemny$material_components_web_elm$Material$Button$disabledAttr = function (_n0) {
...
var aforemny$material_components_web_elm$Material$Button$iconElt = function (_n0) {
	var icon = _n0.icon;
	return A2(
		elm$core$Maybe$map,
		function (iconName) {
...
var aforemny$material_components_web_elm$Material$Button$textButton = F2(
	function (config, label) {
		return A3(aforemny$material_components_web_elm$Material$Button$button, aforemny$material_components_web_elm$Material$Button$Text, config, label);
	});
...
var aforemny$material_components_web_elm$Material$LayoutGrid$layoutGridCell = F2(
	function (attributes, nodes) {
		return A2(
			elm$html$Html$div,
			A2(
...
var aforemny$material_components_web_elm$Material$LayoutGrid$layoutGridInner = F2(
	function (attributes, nodes) {
		return A2(
			elm$html$Html$div,
			A2(
...
var aforemny$material_components_web_elm$Material$Elevation$z6 = aforemny$material_components_web_elm$Material$Elevation$z(6);
var author$project$Main$displayCell = _List_fromArray(
	[
		aforemny$material_components_web_elm$Material$Elevation$z6,
...
var author$project$Main$prettyPrintDuration = function (duration) {
	return elm$html$Html$text(
		elm$core$String$fromInt(
			elm$core$Basics$round(
				ianmackenzie$elm_units$Duration$inDays(duration))) + ' days');
};
...
var author$project$Main$displayChore = F3(
	function (timer, name, chore) {
		return A2(
			...
			_List_fromArray(
				[
					A2(
					aforemny$material_components_web_elm$Material$LayoutGrid$layoutGridInner,
					_List_Nil,
					_List_fromArray(
						[
							A2(
							aforemny$material_components_web_elm$Material$LayoutGrid$layoutGridCell,
							author$project$Main$displayCell,
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									author$project$Main$prettyPrintDuration(
									ianmackenzie$elm_units$Duration$milliseconds(
										elm$time$Time$posixToMillis(timer) - chore.start))
								])),
							A2(
							aforemny$material_components_web_elm$Material$LayoutGrid$layoutGridCell,
							author$project$Main$displayCell,
							_List_fromArray(
								[
									A2(
									aforemny$material_components_web_elm$Material$Button$textButton,
									_Utils_update(
										aforemny$material_components_web_elm$Material$Button$buttonConfig,
										{
											onClick: elm$core$Maybe$Just(
												author$project$Main$Reset(name))
										}),
									'Reset')
								]))
						]))
...
var author$project$Main$displayChores = function (schedule) {
	return elm$core$Dict$values(
		A2(
			elm$core$Dict$map,
			author$project$Main$displayChore(schedule.timer),
			schedule.chores));
};
			...
			switch (error.$) {
				case 'BadUrl':
					...
					return A2(
						...
						_List_fromArray(
							[
								elm$html$Html$text('BadURL: ' + string)
							]));
				case 'Timeout':
					return A2(
						elm$html$Html$div,
				...
				case 'BadStatus':
					...
					return A2(
						...
						_List_fromArray(
							[
								elm$html$Html$text(
								'BadStatus: ' + elm$core$String$fromInt(_int))
							]));
				default:
					var string = error.a;
					return A2(
						...
						_List_fromArray(
							[
								elm$html$Html$text('BadBody: ' + string)
							]));
			}
		default:
			var schedule = model.a;
			return A2(
				elm$html$Html$div,
				_List_Nil,
				author$project$Main$displayChores(schedule));
	}
};
